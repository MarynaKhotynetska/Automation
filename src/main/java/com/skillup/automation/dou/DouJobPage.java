...
public class DouJobPage extends CommonPage {
    ...
    private static final String JOB_LINK_PATTERN = "//a[contains(text(), '%s')]"; //Киев
    ...
    public DouJobPage clickCityJobs(String city) {
        //"//a[contains(text(), '%s')]"; --> //a[contains(text(), 'Киев')]"
    ...
    public DouJobPage assertVacancyNumber(String expectedNumber) {
        ...
        Assert.assertEquals(actualNumber, expectedNumber, "Number of jobs is incorect");
